...
lib WhiteDB
  ...
  fun attach_database = wg_attach_database(Char*, Int) : Void*
  ...
  fun delete_local_database = wg_delete_local_database(Void*) : Void

  
  fun create_record = wg_create_record(Void*, Int) : Void*
  ...
  fun set_field = wg_set_field(Void*, Void*, Int, Int) : Int
  ...
  fun encode_int = wg_encode_int(Void*, Int) : Int
  fun decode_int = wg_decode_int(Void*, Int) : Int
  ...
  fun encode_str = wg_encode_str(Void*, Char*, Char*) : Int
